...
CREATE POLICY "Users can view conversations they participate in or special con"
...
CREATE POLICY "Users can update conversations they participate in or special c"
ON public.conversations
FOR UPDATE
USING (
  (auth.uid() = ANY (participants)) OR 
